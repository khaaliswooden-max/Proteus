# LEDGER ENTRY CANDIDATE — proteus-bench v1.0 (PROTEUS-001)
...
| Field | Value |
|---|---|
| Bundle | `proteus-bench-v1.0/` (9 files, 85,318 bytes) |
| Manifest hash (SHA-256, Merkle-style sorted `rel_path:sha256` lines — same construction as VBX-ISPS LEDGER #0003) | `a802d7e0f2e92d0b8e67eb91fb88d335c444e63db30d89edd647ae01d3ff2331` |
...
```json
{
  ...
  "document_revision": "A",
  "document_title": "PROTEUS-Bench v1.0 — Online State Adaptation Benchmark (Sixth Road Candidate)",
  "ledger_entry_number": "<ENTRY_NUMBER — 4 or 5 per collision resolution>",
  "manifest_byte_count": 85318,
  "manifest_hash": "a802d7e0f2e92d0b8e67eb91fb88d335c444e63db30d89edd647ae01d3ff2331",
  "manifest_hash_algorithm": "SHA-256",
  "predecessor_documents": [
    {
      "document_id": "PROTEUS-spec-v0.1",
      "version": "Proteus_Plasticity_Substrate_Specification.md (pre-hostile-review)"
    }
  ],
...
1. **Independent hash verification** at your machine: unzip the bundle, recompute — any mismatch, STOP and investigate line-ending normalization:
   ...
   # expect: a802d7e0f2e92d0b8e67eb91fb88d335c444e63db30d89edd647ae01d3ff2331
   EOF
   ```
